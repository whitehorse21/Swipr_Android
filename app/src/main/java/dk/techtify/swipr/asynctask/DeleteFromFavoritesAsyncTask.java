...
public class DeleteFromFavoritesAsyncTask extends AsyncTask<Void, Void, Object> {

    private String productId;
    private ApiResponseListener listener;

    public DeleteFromFavoritesAsyncTask(String productId, ApiResponseListener listener) {
    ...
    protected Object doInBackground(Void... params) {
        String url = Constants.Url.DELETE_FROM_FAVOURITES;
        ...
        if (AppConfig.DEBUG) {
            Log.d("DELETE FROM FAVOURITES", "Request url: " + url);
            Log.d("DELETE FROM FAVOURITES", "Request body: " + body.toString());
        }
        ...
        if (AppConfig.DEBUG) {
            Log.d("DELETE FROM FAVOURITES", "Response: " + response);
        }
