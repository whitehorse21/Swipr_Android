...
public class GetFavouritesAsyncTask extends AsyncTask<Void, Void, Object> {
    ...
    public GetFavouritesAsyncTask(String lastId, ApiResponseListener listener) {
        this.lastId = lastId;
    ...
    protected Object doInBackground(Void... params) {
        StringBuilder url = new StringBuilder(Constants.Url.GET_FAVOURITES);
        url.append("&userId=");
