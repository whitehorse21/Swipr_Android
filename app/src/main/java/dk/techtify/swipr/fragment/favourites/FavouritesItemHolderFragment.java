package dk.techtify.swipr.fragment.favourites;
...
public class FavouritesItemHolderFragment extends Fragment implements ValueEventListener {
    ...
    public static FavouritesItemHolderFragment newInstance(Product product) {
        FavouritesItemHolderFragment fragment = new FavouritesItemHolderFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSellerRating = view.findViewById(R.id.rating);
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        if (FavouritesItemHolderFragment.this.isAdded() && dataSnapshot != null && dataSnapshot.getValue() != null) {
